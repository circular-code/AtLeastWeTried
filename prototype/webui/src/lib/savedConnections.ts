...
export function loadSavedConnections(): SavedGatewayConnection[] {
  try {
    ...
    return parsed.flatMap((item) => {
      ...
      const candidate = item as Partial<SavedGatewayConnection>;
...
export function upsertSavedConnection(apiKey: string, teamName = ''): SavedGatewayConnection[] {
  ...
  const nextEntry: SavedGatewayConnection = {
...
export function removeSavedConnection(id: string): SavedGatewayConnection[] {
...
function persist(connections: SavedGatewayConnection[]) {
