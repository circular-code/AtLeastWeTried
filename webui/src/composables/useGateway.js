...
function createGatewayApi() {
    ...
    function addConnection(apiKey, teamName, remember = true) {
    ...
    function attachSavedConnection(savedConnection) {
        queueAttachment(savedConnection.apiKey, savedConnection.teamName);
    }
    function forgetSavedConnection(id) {
        savedConnections.value = removeSavedConnection(id);
    }
    function queueAttachment(apiKey, teamName) {
    ...
    function selectPlayerSession(playerSessionId) {
        if (!playerSessionId) {
            return;
        }
        gameStore.clearOverlay();
    ...
    function detachPlayerSession(playerSessionId) {
        if (!playerSessionId) {
            return;
        }
    ...
    function destroyShip(controllableId) {
        if (!controllableId) {
            return;
        }
    ...
    function continueShip(controllableId) {
        if (!controllableId) {
            return;
        }
    ...
    function removeShip(controllableId) {
        if (!controllableId) {
            return;
        }
    ...
    function setEngine(controllableId, thrust) {
        if (!controllableId) {
            return;
        }
    ...
    function fireWeapon(controllableId) {
        if (!controllableId) {
            return;
        }
    ...
    function fireWeaponAt(controllableId, worldX, worldY) {
        if (!controllableId) {
            gameStore.recordActivity({
                tone: 'warn',
    ...
    function setScannerMode(controllableId, mode) {
        if (!controllableId) {
            return;
        }
        if (mode === 'targeted') {
    ...
    function initiateTargetedScan(controllableId, targetId) {
        if (!controllableId || !targetId) {
            return;
        }
        const envelope = buildSetSubsystemModeCommand(controllableId, 'scanner', 'target', undefined, targetId, gameStore.scannerWidthFor(controllableId), gameStore.scannerLengthFor(controllableId));
        gameStore.trackCommand(envelope.commandId, {
    ...
    function setScannerWidth(controllableId, width) {
        if (!controllableId) {
            return;
        }
    ...
    function setScannerLength(controllableId, length) {
        if (!controllableId) {
            return;
        }
    ...
    function setTacticalMode(controllableId, mode) {
        if (!controllableId) {
            return;
        }
    ...
    function setTacticalTarget(controllableId, targetId) {
    ...
    function setNavigationTarget(controllableId, worldX, worldY, thrustPercentage, direct) {
        if (!controllableId) {
            gameStore.recordActivity({
                tone: 'warn',
                summary: 'No active ship selected',
        ...
        const envelope = buildSetNavigationTargetCommand(controllableId, worldX, -worldY, thrustPercentage, direct);
        gameStore.trackCommand(envelope.commandId, {
            label: direct ? 'Set navigation target (direct)' : 'Set navigation target',
    ...
    function clearNavigationTarget(controllableId) {
        if (!controllableId) {
            return;
        }
    ...
    function upgradeSubsystem(controllableId, subsystemId) {
    ...
    function setSubsystemMode(controllableId, subsystemId, mode, value, targetId) {
